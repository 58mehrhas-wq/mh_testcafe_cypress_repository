...
export class Eyes {
    ...
    constructor(config?: ConfigurationPlain, runner?: EyesRunner);
    constructor(options: { configPath: string; runner?: EyesRunner; });
    get logger(): Logger;
    getLogger(): Logger;
...
export type TestCafeConfiguration = {
    appName?: string;
    testName?: string;
    browser?: DesktopBrowserInfo | ChromeEmulationInfo | IOSDeviceInfo | Array<DesktopBrowserInfo | ChromeEmulationInfo | IOSDeviceInfo>;
    batchId?: string;
    batchName?: string;
    ...
    baselineEnvName?: string;
    envName?: string;
    proxy?: string | ProxySettingsPlain;
    ignoreCaret?: boolean;
...
export type TestCafeCheckSettings = {
    ...
    selector?: Selector;
    region?: RegionPlain;
    ignore?: (Selector | RegionPlain | { selector: Selector; }) | Array<Selector | RegionPlain | { selector: Selector; }>;
    floating?: ((Selector | RegionPlain | { selector: Selector; }) & { maxUpOffset?: number; maxDownOffset?: number; maxLeftOffset?: number; maxRightOffset?: number; }) | Array<(Selector | RegionPlain | { selector: Selector; }) & { maxUpOffset?: number; maxDownOffset?: number; maxLeftOffset?: number; maxRightOffset?: number; }>;
    layout?: (Selector | RegionPlain | { selector: Selector; }) | Array<Selector | RegionPlain | { selector: Selector; }>;
    content?: (Selector | RegionPlain | { selector: Selector; }) | Array<Selector | RegionPlain | { selector: Selector; }>;
    strict?: (Selector | RegionPlain | { selector: Selector; }) | Array<Selector | RegionPlain | { selector: Selector; }>;
    accessibility?: ((Selector | RegionPlain | { selector: Selector; }) & { accessibilityType: AccessibilityRegionType; }) | Array<(Selector | RegionPlain | { selector: Selector; }) & { accessibilityType: AccessibilityRegionType; }>;
